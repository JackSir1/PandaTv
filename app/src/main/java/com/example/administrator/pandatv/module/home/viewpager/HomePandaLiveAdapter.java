...
public class HomePandaLiveAdapter extends BaseAdapter {
    private List<HomeBean.DataBean.PandaliveBean.ListBean> pandaliveBeans;
    private LayoutInflater inflater;
    private Context context;
    public HomePandaLiveAdapter(Context context,List<HomeBean.DataBean.PandaliveBean.ListBean> pandaliveBeans){
    ...
    class HolderView{
        ...
        public void setDate(HomeBean.DataBean.PandaliveBean.ListBean bean){
