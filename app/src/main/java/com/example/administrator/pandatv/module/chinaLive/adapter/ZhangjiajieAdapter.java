...
public class ZhangjiajieAdapter extends BaseAdapter<ZhangJiajie.LiveBean> {


    public ZhangjiajieAdapter(Context context, List<ZhangJiajie.LiveBean> datas) {
        super(context, R.layout.livechina_adapter,datas);
    }

    @Override
    public void convert(ViewHolder holder, ZhangJiajie.LiveBean liveBean) {
