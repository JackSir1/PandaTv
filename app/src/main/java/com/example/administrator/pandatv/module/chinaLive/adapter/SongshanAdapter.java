...
public class SongshanAdapter extends BaseAdapter<SongShanBean.LiveBean> {


    public SongshanAdapter(Context context,List<SongShanBean.LiveBean> datas) {
        super(context, R.layout.livechina_adapter,datas);
    }

    @Override
    public void convert(ViewHolder holder, SongShanBean.LiveBean liveBean) {
