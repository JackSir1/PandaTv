...
import com.example.administrator.pandatv.module.chinaLive.adapter.HuangshanAdapter;
 ...
 */
public class HuangShanFragment extends BaseFragment implements HuangShanContract.View {
    HuangShanContract.Presenter presenter;
    @BindView(R.id.pulltorefresh)
    PullToRefreshRecyclerView pullframent;
    Unbinder unbinder;
    private HuangshanAdapter songshanAdapter;
    private List<HuangShanBean.LiveBean> mList;
    @Override
...
//                songshanAdapter.notifyDataSetChanged();
    ...
    @Override
    public void setResult(HuangShanBean songShanBean) {
        List<HuangShanBean.LiveBean> live = songShanBean.getLive();
        mList.addAll(live);
        songshanAdapter =new HuangshanAdapter(getContext(),mList);
        pullframent.setAdapter(songshanAdapter);
        songshanAdapter.notifyDataSetChanged();
    }

    @Override
    public void setPresenter(HuangShanContract.Presenter presenter) {
