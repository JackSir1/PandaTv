...
public class HomeChinaLiveAdapter extends BaseAdapter {
    private List<HomeBean.DataBean.ChinaliveBean.ListBeanXX> pandaliveBeans;
    private LayoutInflater inflater;
    private Context context;
    public HomeChinaLiveAdapter(Context context, List<HomeBean.DataBean.ChinaliveBean.ListBeanXX> pandaliveBeans){
    ...
    class HolderView{
        ...
        public void setDate(HomeBean.DataBean.ChinaliveBean.ListBeanXX bean){
