...
public class EMeiShanAdapter extends BaseAdapter<EMeiShanBean.LiveBean> {

    public EMeiShanAdapter(Context context, List<EMeiShanBean.LiveBean> datas) {
        super(context, R.layout.livechina_adapter, datas);
    }

    @Override
    public void convert(ViewHolder holder, EMeiShanBean.LiveBean liveBean) {
