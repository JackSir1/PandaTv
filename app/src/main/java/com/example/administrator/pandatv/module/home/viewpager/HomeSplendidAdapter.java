...
public class HomeSplendidAdapter extends BaseAdapter {
    private List<HomeBean.DataBean.AreaBean.ListscrollBean> pandaliveBeans;
    private LayoutInflater inflater;
    private Context context;
    public HomeSplendidAdapter(Context context, List<HomeBean.DataBean.AreaBean.ListscrollBean> pandaliveBeans){
